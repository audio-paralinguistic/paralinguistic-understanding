...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Animate only efficiency block numbers; hero .stat-number uses labels like 1.2M+ and 6K and must not be passed through the numeric counter.
    document.querySelectorAll('.efficiency-showcase .big-number').forEach(stat => {
...
function copyBibtex() {
    const bibtexText = `@inproceedings{anonymous2026parallm,
